...
tags: ["テンプルステイ", "全州旅行", "韓国仏教", "ヒーリング", "ソゴサ"]
author: "K-Life Hack"
---
...
<div class="psImg"><img alt="An overhead view of traditional Korean temple rooftops with dark tiles and red eaves, seen from a higher vantage point with bare tree branches. - 全州(チョンジュ)西古寺(ソゴサ)で心癒すテンプルステイ体験：静寂の中で見つける本当の自分" decoding="async" loading="lazy" src="https://cdn.jsdelivr.net/gh/bbobboyya00-cmyk/k-life-assets@main/assets/2026/khack_1776385517_5.webp" style="width: auto; max-width: 100%; height: auto; object-fit: contain; border-radius: 12px; margin: 35px auto; display: block; box-shadow: 0 4px 15px rgba(0,0,0,0.1);"/><img alt="A traditional Korean temple building (Samseonggak) with yellow walls and a red roof, built on a stone foundation against a rocky slope. - 全州(チョンジュ)西古寺(ソゴサ)で心癒すテンプルステイ体験：静寂の中で見つける本当の自分" decoding="async" loading="lazy" src="https://cdn.jsdelivr.net/gh/bbobboyya00-cmyk/k-life-assets@main/assets/2026/khack_1776385519_6.webp" style="width: auto; max-width: 100%; height: auto; object-fit: contain; border-radius: 12px; margin: 35px auto; display: block; box-shadow: 0 4px 15px rgba(0,0,0,0.1);"/></div>
: An overhead view of traditional Korean temple rooftops with dark tiles and red eaves, seen from a higher vantage point with bare tree branches.
: A traditional Korean temple building (Samseonggak) with yellow walls and a red roof, built on a stone foundation against a rocky slope.
...
<h3 class="k-map-title" style="color: var(--themeC); font-size: 1.2rem; font-weight: 800; margin: 0px 0px 5px;">📍 서고사
